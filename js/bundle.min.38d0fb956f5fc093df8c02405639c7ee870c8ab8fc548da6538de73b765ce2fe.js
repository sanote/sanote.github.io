...
var ncnts=0;for(const key in cnts){if(cnts.hasOwnProperty(key)){const element=cnts[key];if(element.innerHTML=='_')ncnts++;else if(element.innerHTML!='0')element.style.display='inline';}}
