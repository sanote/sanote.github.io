...
var ntabs=document.querySelectorAll('#arctab li');for(var i=0;i<ntabs.length;i++){ntabs[i].onclick=function(){document.documentElement.scrollTop=document.getElementById(this.getAttribute('data-id')).offsetTop-60;}}
